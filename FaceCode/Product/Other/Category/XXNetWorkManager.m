...
+ (void)requestWithMethod:(HTTPMethod)method
    ...
    switch (method) {
        case GET: {
            [[XXNetWorkManager sharedManager] GET:urlStr
                parameters:params
        ...
        case POST: {
            [[XXNetWorkManager sharedManager] POST:urlStr
                parameters:params
...
+ (void)cancelHttpRequestWithRequestType:(NSString *)requestType requestUrlString:(NSString *)string {
    ...
    NSString *urlToPeCanced =
        [[[[XXNetWorkManager sharedManager].requestSerializer requestWithMethod:requestType URLString:string parameters:nil error:&error] URL] path];
